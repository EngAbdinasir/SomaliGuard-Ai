        ...
        <aside className="login-redesign-panel">
          <div className="login-redesign-brand">
            ...
            <div>
              ...
              <small>Offensive Text Detection</small>
            </div>
          </div>

          <div className="login-redesign-copy">
            <span className="login-redesign-kicker"><ShieldCheck size={15} /> Secure workspace</span>
            <h1>Analyze Somali text and images with confidence.</h1>
            <p>Sign in to continue reviewing predictions, checking history, and managing moderation workflows.</p>
          </div>
