    ...
    <main className="page" style={{ padding: '32px 20px', maxWidth: '1500px', margin: '0 auto' }}>
      <section className="dashboard-hero" style={{ minHeight: '170px', marginBottom: '22px' }}>
        <div>
          ...
          <p>Your saved text and image analysis records. Search, filter, and review confidence scores from previous predictions.</p>
        </div>
      ...
      <div className="responsive-record-card" style={{ display: 'grid', gridTemplateColumns: 'minmax(160px, 0.75fr) minmax(280px, 2fr) minmax(220px, 0.9fr)', gap: '18px', alignItems: 'center' }}>
        ...
        <div>
          ...
          <div style={{ height: '8px', background: 'var(--bg)', borderRadius: '999px', overflow: 'hidden', border: '1px solid var(--line)' }}>
            <div style={{ width: `${confidence}%`, height: '100%', background: color, borderRadius: '999px' }} />
          </div>
        </div>
      </div>
    </article>
